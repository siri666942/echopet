...
Top section (Status Monitor): A small, inset green LCD screen (like an old calculator or Walkman display). Inside the screen: pixelated text showing "STATUS: FINDING VIBE...", a tiny pixel-art avatar of a cute creature, and a small animated equalizer bar.
